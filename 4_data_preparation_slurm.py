...
if __name__ == '__main__':
    ...
    for i in range(total_data_num//BATCH_NUM):
        ...
        print(f'saved_total_fields : {saved_total_fields.shape}', flush=True)
        np.save(f'total_fields_{total_energy}nJ_{i+1}.npy', saved_total_fields)
        print(f'save complete {i+1}', flush=True)
